(defproject jackal "0.1.0-SNAPSHOT"
  :description "A fractal visualizer"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "jackal.core/on-figwheel-reload"}

                :compiler {:main jackal.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/jackal.js"
